...
This is merely the Zed client for an *already-existing* copy of the Axe Accessibility Linter langauge server executable. You will need that executable in order for the extension to work!
